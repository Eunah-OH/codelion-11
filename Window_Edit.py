...
class Window_Edit_User():
    ...
    def __init__(self, window, x, y):
        ...
        self.label_id = Label(window, text="회원 ID : ")        
        self.label_id.place(x=x, y=y+50)

        self.label_password = Label(window, text="비밀번호 : ")        
        self.label_password.place(x=x, y=y+75)
        
        self.label_email = Label(window,text="이메일 : ")
        self.label_email.place(x=x,y=y+100)

        self.label_gender = Label(window, text = "성별 : ")
        self.label_gender.place(x=x,y=y+125)

        self.label_birthday = Label(window, text = "생년월일 : ")
        self.label_birthday.place(x=x,y=y+150)

        self.label_registration = Label(window,text="상태 : ")
        self.label_registration.place(x=x,y=y+175)
        
        self.label_overdue = Label(window,text="연체 : ")
        self.label_overdue.place(x=x,y=y+200)

        self.entry_phone = Entry(window)
        self.entry_phone.place(x=x+60, y=y+25, width=ENTRY_WIDTH)

        self.entry_name = Entry(window)
        self.entry_name.place(x=x+60, y=y, width=ENTRY_WIDTH)

        self.entry_id = Entry(window, text="회원 ID : ")        
        self.entry_id.place(x=x+60, y=y+50, width=ENTRY_WIDTH)

        self.entry_password = Entry(window, text="비밀번호 : ")        
        self.entry_password.place(x=x+60, y=y+75, width=ENTRY_WIDTH)

        self.entry_birthday = Entry(window)
        self.entry_birthday.place(x=x+60,y=y+150, width=ENTRY_WIDTH)
        ...
        self.gender_rb1.place(x=x+60,y=y+125)
        self.gender_rb2.place(x=x+140,y=y+125)
        ...
        self.registration_rb1.place(x=x+60,y=y+175)
        self.registration_rb2.place(x=x+140,y=y+175)
        self.CheckButton_overdue = IntVar(window)
        self.overdue_b1 = Checkbutton(window, text="연체중", variable=self.CheckButton_overdue)
        self.overdue_b1.place(x=x+60, y=y+200)
    ...
    def get_overdue(self):
        od_boolean = bool(self.CheckButton_overdue.get())
        return od_boolean
...
class Window_Edit_Book():
    ...
    def __init__(self, window, x, y):
        ...
        self.entry_isbn.place(x=x+60, y=y+75, width=ENTRY_WIDTH)

        self.entry_title = Entry(window)
        self.entry_title.place(x=x+60, y=y, width=ENTRY_WIDTH)

        self.entry_author = Entry(window)
        self.entry_author.place(x=x+60, y=y+25, width=ENTRY_WIDTH)

        self.entry_publisher = Entry(window)
        self.entry_publisher.place(x=x+60, y=y+50, width=ENTRY_WIDTH)
        ...
        self.entry_book_explain.place(x=x+60, y=y+125, width=ENTRY_WIDTH, height=60)
