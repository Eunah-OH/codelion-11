...
# 클래스: 회원 정보 패널
# ======================================================================================================================
class Window_Show_User():

    # 생성자
    def __init__(self, window, x, y):
        self.user_editor = Window_Edit_User(window, x+135, 100)      # 회원 정보 입력하는 패널 붙이기
...
# 클래스: 도서 정보 패널
# ======================================================================================================================
class Window_Show_Book():

    # 생성자
    def __init__(self, window, x, y):
        self.book_editor = Window_Edit_Book(window, x+135, 100)    # 도서 정보 입력하는 패널 붙이기
        self.load_widgets(window, x, y)
        self.load_table(window, x, y)
    ...
    def event_book_delete(self):
        ...
        df_book = pd.read_csv(DIR_CSV_BOOK, encoding='CP949', dtype= {"BOOK_TITLE":object, "BOOK_AUTHOR":object, "BOOK_PUB":object, "BOOK_DESCRIPTION": object})
